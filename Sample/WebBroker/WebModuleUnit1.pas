...
type
  TWebModule1 = class(TWebModule)
    ...
    procedure WebModule1tbgchartAction(Sender: TObject; Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
    procedure WebModuleCreate(Sender: TObject);
    procedure WebModule1chartsnocdnAction(Sender: TObject; Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
  end;
...
procedure TWebModule1.WebModule1chartsnocdnAction(Sender: TObject; Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
begin
  Response.Content :=
    WebCharts1
...
procedure TWebModule1.WebModule1tbgchartAction(Sender: TObject; Request: TWebRequest; Response: TWebResponse; var Handled: Boolean);
begin
  Response.Content :=
    WebCharts1
      //.AddResource('<link href="green.css" rel="stylesheet">')
